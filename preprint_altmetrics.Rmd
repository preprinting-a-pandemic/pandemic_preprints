...
tweets <- map_dfr(altmetrics_data, getTweetIDs)
...
tweet_ids %>%
  ...
  select(user_id, tweet_id, status_url, created_at, screen_name, text, reply_to_status_id,
         ...
         retweet_user_id, retweet_text, retweet_created_at, retweet_retweet_count, followers_count,
         location, description) %>%
  distinct() %>%
  write_csv("data/preprint_tweets.csv")
