...
# Figure caption
caption <- str_wrap("Figure X: Development of COVID-19 and publication response between January 2020 and April 2020. (A) Number of COVID-19 confirmed cases and reported deaths. Data from https://github.com/datasets/covid-19/. (B) Cumulative growth of journal articles and preprints containing COVID-19 related search terms. (C) Cumulative growth of preprints containing COVID-19 related search terms, broken down by individual preprint server. Journal data in (B) is based upon data extracted from Dimensions (https://www.dimensions.ai), preprint data in (B) and (C) is derived from a repository of preprint metadata maintained by Fraser and Kramer (2020; https://doi.org/10.6084/m9.figshare.12033672).", width = 150)
