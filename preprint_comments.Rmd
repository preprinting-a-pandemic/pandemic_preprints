...
medrxiv_post_counts <- map_dfr(medrxiv_data, extractCommentCounts) %>%
  distinct() %>%
  group_by(doi) %>%
...
biorxiv_post_counts <- map_dfr(biorxiv_data, extractCommentCounts) %>%
  distinct() %>%
  group_by(doi) %>%
  mutate(comments_count = sum(comments_count)) %>%
  ungroup() %>%
...
preprint_post_counts <- bind_rows(medrxiv_post_counts, biorxiv_post_counts) %>%
